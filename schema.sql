...
alter table public.profiles drop constraint if exists profiles_special_card_check;
alter table public.profiles add constraint profiles_special_card_check check (special_card is null or special_card in ('RESONANCE'));
