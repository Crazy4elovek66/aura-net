...
export const VOTE_PAIR_COOLDOWN_HOURS = 12;

export const REFERRAL_ACTIVITY_PERCENT = 10;
export const REFERRAL_ACTIVITY_DAILY_CAP = 20;
export const REFERRAL_ACTIVITY_DURATION_DAYS = 90;
