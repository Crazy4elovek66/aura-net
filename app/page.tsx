            ...
            {[
              {
                step: "01",
                icon: "🪪",
                title: "Оформи карточку",
                desc: "Выбери ник, выстави имя и статус. Это твоя живая карточка ауры.",
              },
              {
                step: "02",
                icon: "🔗",
                title: "Поделись ссылкой",
                desc: "Отправь персональную ссылку друзьям и аудитории, чтобы тебя чекнули.",
              },
              {
                step: "03",
                icon: "⚡",
                title: "Получи оценку",
                desc: "Люди голосуют +Аура или −Аура. Расти в тирах, выходи в лидерборд, получай статус.",
              },
            ].map((item, i) => (
              <motion.div
                key={i}
